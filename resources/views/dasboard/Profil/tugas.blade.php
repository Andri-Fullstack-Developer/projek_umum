<div class="container-fluid pt-4 px-4">
    <div class="bg-secondary rounded-top p-4">
        <h1 class="text-center ket">Data Profil Tugas</h1>
        @if (session('success'))
        ...
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal-tugas">
            Tambah Data
        </button>
        <div class="row">
...
<!-- Modal Penjabat-->
<div class="modal fade" id="exampleModal-tugas" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" style="background: #000">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ url('post-tugas') }}" enctype="multipart/form-data">
                    @csrf
                    <label class="model-la" for="nama">Name</label>
                    <input class="model-in" type="text" name="nama" placeholder="Full Name">
                    <label class="model-la" for="nama">Alamat</label>
